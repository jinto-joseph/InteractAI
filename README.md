...
Install Python:
Download and install Python 3.8 or 3.9 from python.org. Avoid using Python 3.10+ as MediaPipe may have compatibility issues with newer versions.
...
Run the Script:
Ensure your webcam is connected and the virtual environment is activated.
...
Check if the webcam index (cv2.VideoCapture(0)) needs to be changed to 1 or another value.
...
LinkedIn: linkedin.com/in/jinto-joseph-9937a5324
